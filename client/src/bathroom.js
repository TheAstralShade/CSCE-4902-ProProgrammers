...
let items=[['Monday',0,0],['Tuesday',0,0],['Wednesday',0,0],['Thursday',0,0],['Friday',0,0],['Saturday',0,0],['Sunday',0,0]['imprtnt',1]];
  ...
  render(){
    return ( 
      ...
      <div id="LoginBox" class = "LoginCenter">
        ...
        <div class = "spacer"> </div>
        <input onChange={this.handleChkBox} type="checkbox" id="impchk" name="check" value="imp" checked={this.state.imp}></input>
